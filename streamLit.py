...
st.set_page_config(page_title=title, page_icon=":hospital:")

# Define clf at the beginning of the script
clf = None

# Define the cryptographic key for encrypting patient data
key = b'your_secret_key'  # Replace with a secure key
...
# Separate login and create account page for doctors
def login_or_create_account():
    st.title("Doctor Login / Create Account")
    st.markdown("Please enter your credentials to log in or create an account.")

    # Implement doctor login and account creation logic here
    # ...

# Check if the doctor is logged in
doctor_logged_in = st.checkbox("Doctor logged in")
...
# If the doctor is not logged in, show the login or create account page
else:
